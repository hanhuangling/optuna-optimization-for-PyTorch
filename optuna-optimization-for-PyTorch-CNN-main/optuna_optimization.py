...
class Net(nn.Module):
    ...
    """
    def __init__(self,  num_conv_layers, num_filters, num_neurons, drop_conv2, drop_fc1):
        """Parameters:
...
def objective(trial):
    ...
    # Generate the model
    model = Net( num_conv_layers, num_filters, num_neurons, drop_conv2,  drop_fc1).to(device)
...
if __name__ == '__main__':
    ...
    number_of_trials = 5                # Number of Optuna trials
    ...
    directory_name = r'E:\desktop\optuna-optimization-for-PyTorch-CNN-main\datasets'
    if not os.path.exists(directory_name):
        os.mkdir(directory_name)

    # Download MNIST dataset to 'files' directory and normalize it
    train_loader = torch.utils.data.DataLoader(
        torchvision.datasets.MNIST(directory_name, train=True, download=True,
    ...
    test_loader = torch.utils.data.DataLoader(
        torchvision.datasets.MNIST(directory_name, train=False, download=True,
                                   transform=torchvision.transforms.Compose([
                                       torchvision.transforms.ToTensor(),
                                       torchvision.transforms.Normalize((0.1307,), (0.3081,))])),
